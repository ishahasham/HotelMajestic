...
export default function Sidebar() {
  ...
  const menuItems = [
    { name: 'Dashboard', links: [{ name: 'Dashboard Page', href: '/customer-dashboard' }] },
    { name: 'Booking', links: [{ name: 'Beach View Rooms', href: '/Booking/BookBeachViewRooms' }, { name: 'Pool Side Rooms', href: '/Booking/BookPoolSideRooms' }, {name: 'GYM', href:'/Booking/GYM'}] },
    { name: 'Rooms', links: [{ name: 'Beach View Rooms', href: '/Rooms/BeachViewRooms' }, { name: 'Pool Side Room', href: '/Rooms/PoolSideRooms' }] },
    { name: 'Services', links: [{ name: 'All Services', href: '/Services'} ] },
    { name: 'Contact Us', links: [{ name: 'Contact Page', href: '/ContactPage' }] },
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      padding: '0.5rem'
        ...
        <Toolbar>
          ...
          >
           <AccountCircle // Change cursor style to pointer
      />
    ...
    '@media (max-width: 480px)': {
      width: open ? 180 : 0, // Smaller width for very small screens
      '& .MuiDrawer-paper': {
        width: open ? 180 : 0,
      },
    },
