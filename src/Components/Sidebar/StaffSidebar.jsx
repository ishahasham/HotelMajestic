...
export default function StaffSidebar() {
  ...
  const menuItems = [
    { name: 'Dashboard', links: [{ name: 'Dashboard Page', href: '/staff-dashboard' }] },
    { name: 'Booking Table', links: [{ name: 'Booked Room', href: '/Booking/Staff/RoomTable' },{ name: 'Booked Gym', href: '/Booking/Staff/GymTable' }] },
    { name: 'Contact Information', links: [{ name: 'Contact Table', href: '/Contact/Staff/ContactTable' }] },
  ];
