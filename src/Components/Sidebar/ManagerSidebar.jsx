...
export default function ManagerSidebar() {
  ...
  const menuItems = [
    { name: 'Dashboard', links: [{ name: 'Dashboard Page', href: '/manager-dashboard' }] },
    { name: 'Booking Table', links: [{ name: 'Booked Room', href: '/Booking/Manager/RoomTable' },{ name: 'Booked Gym', href: '/Booking/Manager/GymTable' }] },
    { name: 'Contact Information', links: [{ name: 'Contact Table', href: '/Contact/Manager/ContactTable' }] },
    { name: 'All Payments', links: [{ name: 'Payment Table', href: '/Payment/Manager/PaymentTable' }] },
  ];
